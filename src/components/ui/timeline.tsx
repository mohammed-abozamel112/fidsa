...
export const Timeline = ({ data, direction = "rtl" }: TimelineProps) => {
    ...
    >
      ...
      >
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base w-full">
          نحن فريق متخصص يقدم خدمات مبتكرة في مجال التكنولوجيا والتصميم، ملتزمون
          بتوفير حلول تلبي احتياجات عملائنا.
        </p>
      </div>
